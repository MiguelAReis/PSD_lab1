...
HD_PWD='/home/miguel/Desktop/PSD/PSD_lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log finalCircuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source finalCircuit.tcl
